...
export const AZURE = {
  ...
  // Enlace compartido de la carpeta raíz en SharePoint. Se deja vacío porque el
  // repositorio es público: la app lo pide al conectar y lo guarda en el navegador.
  shareUrl: '',
};

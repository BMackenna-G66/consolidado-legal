...
<p class="nota">Reporte estático: refleja los documentos existentes al momento de generarlo. Para una versión al día, pídele al equipo de Compliance que lo regenere.</p>
</main>
<script>
const D = ${datos};
